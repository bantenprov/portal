...
export default ({ authGuard, guestGuard }) => [
...

  {
    path: '/listcontent',
    name: 'listcontent',
    component: resolve => require(['~/components/views/Leftsidebar.vue'], resolve),
    meta: {
      title: "Content | Portal Banten"
    }
  },

  {
    path: '/detailcontent',
    name: 'detailcontent',
    component: resolve => require(['~/components/views/Detailcontent.vue'], resolve),
    meta: {
      title: "Detail Content | Portal Banten"
    }
  },
